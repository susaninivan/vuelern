...
export default {
  ...
  data() {
    return {
      ...
      messages: [
        ...
        "У тебя все получится. Попробуй | Неизвестный",
  ...
  // },
  // mounted() {
  //   this.message = `${randomItem(messages)}`;
  // },
  // mounted() {
  //       this.randomItem();
  //     },
  ...
  methods: {
    ...
    // console.log (`${randomItem(messages)}`)
    // addText() {
    //   this.message = `${randomItem(messages)}`;
    // }
  },
